import{Aa as g,Da as A,Ga as P,j as Q,m as E,o as N,t as O,za as q}from"./chunk-G3ZQPBPZ.js";import{Ab as k,Bb as I,Ec as B,Hb as u,Ib as d,Jb as x,Kb as M,Lb as w,Sb as l,Tb as D,Ub as F,Vb as f,Wa as o,X as v,Xb as m,Y as h,Yb as y,ba as T,bc as j,cc as S,ic as z,kb as b,la as p,lb as C,ob as $,qb as r,xb as i}from"./chunk-LW3WOUBG.js";var V=["icon"],H=["*"];function G(e,c){if(e&1&&x(0,"span",4),e&2){let t=l(2);i("ngClass",t.icon)}}function J(e,c){if(e&1&&(M(0),r(1,G,1,1,"span",3),w()),e&2){let t=l();o(),i("ngIf",t.icon)}}function K(e,c){}function L(e,c){e&1&&r(0,K,0,0,"ng-template")}function U(e,c){if(e&1&&(u(0,"span",5),r(1,L,1,0,null,6),d()),e&2){let t=l();o(),i("ngTemplateOutlet",t.iconTemplate||t._iconTemplate)}}var W=({dt:e})=>`
.p-tag {
    display: inline-flex;
    align-items: center;
